...
package com.bsxapp.nativeModules.openCV;
...
//        System.loadLibrary("libopencv_java3.so");
    ...
    @ReactMethod
    public void cvtColor(ReadableMap sourceMat, ReadableMap destMat, int convColorCode, final Promise promise) {
        ...
        result.merge(destMat);
        System.out.println(dstMat);
